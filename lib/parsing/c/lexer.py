...
class IntegerLiteral:
    ...
    def parse(state: LexerState) -> LexerRet[Self]:
        ...
        #     # if len(state) < 1:
        #     #     return Err(LexerError(state))
        #     res = None
        #     match look_ahead(state, 1):
        #         case Err(_): return IntegerConstantType.INT
        #         case Ok(([c], rest)): res = IntegerConstantType.INT
        #         case e: raise UnreachableError(e)

        #     if c in ['u', 'U']:
        #         match look_ahead(rest, 1):
        #             case Err(_): return IntegerConstantType.UINT
        #             case Ok(([c], rest)): res = IntegerConstantType.UINT
        #             case e: raise UnreachableError(e)

        #         if c in ['l', 'L']:
        #             match look_ahead(rest, 1):
        #                 case Err(_): return IntegerConstantType.ULONG
        #                 case Ok(([c], rest)): res = IntegerConstantType.ULONG
        #                 case e: raise UnreachableError(e)

        #             if c in ['l', 'L']:
        #                 match look_ahead(rest, 1):
        #                     case Err(_): return IntegerConstantType.ULLONG
        #                     case Ok(([c], rest)): res = IntegerConstantType.ULLONG
        #                     case e: raise UnreachableError(e)

        #     elif c in ['l', 'L']:
        #         match look_ahead(rest, 1):
        #             case Err(_): return IntegerConstantType.LONG
        #             case Ok(([c], rest)): res = IntegerConstantType.LONG
        #             case e: raise UnreachableError(e)

        #         if c in ['l', 'L']:
        #             match look_ahead(rest, 1):
        #                 case Err(_): return IntegerConstantType.LLONG
        #                 case Ok(([c], rest)): res = IntegerConstantType.LLONG
        #                 case e: raise UnreachableError(e)
        ...
        #     if re.match("[_a-zA-Z0-9]", c) is None:
        #         return res
        #     else:
        #         return Err(LexerError(rest, "end of the literal", c))
